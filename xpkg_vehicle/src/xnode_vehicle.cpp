...
static std::string arr_dev_list[] = {"ECHO-STD","ECHO-PRO","ECHO-PLUS",
                                     ...
                                     "MARK1-DIFF","MARK1-MCNM","MARK2-DIFF","MARK2-MCNM","MARK3-DIFF","MARK3-MCNM",
                                     "RAY","ARK","NEOS"};
static double arr_dev_wheel_track_list[] = {0.453,0.453,0.453,
                                            0.236,0.236,0.236,
                                            0.5,0.5,0.5,0.5,0.709,0.5};
///////////////////custom device info/////////////////
static std::string arr_dev_list_c[] ={"MARK-C1"};
static double arr_dev_wheel_track_list_c[] = {0.500};
///////////////////EX device info/////////////////
...
int main(int argc, char **argv)
{
    ...
    if(vehicle_info.s_type > 0xC0)
    {
        ROS_INFO("\033[1;32mxnode_vehicle: %s online \033[0m",arr_dev_list_c[vehicle_info.s_type - 0xc1].data());
        wheel_track = arr_dev_wheel_track_list_c[vehicle_info.s_type - 0xc1];
    }
    else if(vehicle_info.s_type > 0xa0)
        {
    ...
    pub_comm.publish(vehicle_dc.VehicleMode(MODE_CAN,BEEP_OFF,0));
    ...
    //calculate odom//////////////////////////////////////////////////
    //ROS_INFO("%d",vehicle_info.s_speed_x);
